...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  private String virtualObjectTextureDir = null;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Button rollingButton = findViewById(R.id.rollingButton);
    rollingButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Intent intent = new Intent(HelloArActivity.this, HelloArActivity.class);
  ...
  public void onSurfaceCreated(SampleRender render) {
    ...
    try {
      ...
      texturename = getString(R.string.picName);
  ...
  private void rollDice() {
    ...
    texturename = getString(R.string.picName, randomNum);
  }
